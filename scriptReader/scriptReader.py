...
finishButton = Button(window, text="\tPlease select all messages which caused a topic shift, scroll down to view all messages and click Finish and Submit when complete.\t\t", font = ('Times New Roman', 18))
...
#Button placed at the bottom of the program that executes write_file()
finishButton = Button(window, text="Finish and Submit", command = write_file, font = ('Times New Roman', 18))
T.window_create("end", window=finishButton, align = 'baseline')
